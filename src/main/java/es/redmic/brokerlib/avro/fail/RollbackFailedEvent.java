...
public class RollbackFailedEvent extends BaseRollbackEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"RollbackFailedEvent\","
	...
	static String type = EventTypes.ROLLBACK_FAILED;

	public RollbackFailedEvent() {
		super(type);
	}

	public RollbackFailedEvent(String failEventType) {
		super(type);
		this.setFailEventType(failEventType);
	}
